...
<body>
	...
	<div class="wrapper" id="content">
		...
		<div class="header">
			<!-- 绝对定位的logo -->
			<div class="logo">
				<a href="index" title="千氏商城" class="home"> <span>千氏商城</span>
				</a>
			</div>
			<!-- 占据高度DIV -->
			<div class="tit"></div>
			...
			<div class="right">
				<ul>
					<li class="user">			
							<a href="loginPage" title="退出" class="home"> <span>退出</span></a>
					</li>
					<li class="cart"><a href = "shoppingCart" title="购物车"> <span
		...
		<div class="nav-wrap nav-index">
			<div id="slider_nav" class="swipe" style="visibility: visiable;">
				<div class="swipe-wrap">
					...
					<div data-index="0">
						<ul>
							<li><a  data-log="B0-#/product/category"
							...
							<li><a 
								...
								onclick="_msq.push(['trackEvent', 'c499efdd9c939a49-edfd3e1d45a48ac3', 'http://m.xiaomi.cn/', 'pcpid']);"><span
									class="icon icon-shequ"></span><span class="t"><span>社区</span></span></a></li>
						</ul>
					</div>

					<div data-index="1">
						<ul>
							<li><a  data-log="B0-#/heyue"
								data-stat-id="b2173beffbc2a4b5"
								onclick="_msq.push(['trackEvent', 'c499efdd9c939a49-b2173beffbc2a4b5', '#/heyue', 'pcpid']);"><span
									class="icon icon-heyueji"></span><span class="t"><span>待开发</span></span></a></li>
							<li><a  data-log="B1-#/fcode"
								data-stat-id="90f2ce1fecd81997"
								onclick="_msq.push(['trackEvent', 'c499efdd9c939a49-90f2ce1fecd81997', '#/fcode', 'pcpid']);"><span
									class="icon icon-fcode"></span><span class="t"><span>待开发</span></span></a></li>
							<li><a 
								...
								onclick="_msq.push(['trackEvent', 'c499efdd9c939a49-a1bc230f9e518de9', '#/recharge/productlist', 'pcpid']);"><span
									class="icon icon-huafeichongzhi"></span><span class="t"><span>待开发</span></span></a></li>
						</ul>
					</div>
				...
				<div class="list-cell">
					<#list mapItem["${key}"] as u> 
						<#if u_index %2!=1 >
							...
							<div class="cell">
								<a  data-log="itemDesc?id=${u.id}" href="itemDesc?id=${u.id}"  data-stat-id="d4bfa347f5a83ea8"> 
									<span class="imgurl">
										<img src="${u.image}" width="50%" height="70%">
										<div class="list">
											<span class="p">
												<span>${u.title}</span>
											</span>
											<span class="p">
												<span style="color: red">${u.price}元起</span> 
												<del></del>
											</span>
										</div>
									</span>
